...
myItemName = "Starting Key";
myItemAmount = 1;
myItemDescription = "It's a candy key.";
myItemSprite = spr_StartingKey;
myItemScript = undefined;

pickUp = true;  // Is this an item that can go in inventory?
close = "That makes no sense.";
consume = "You probably shouldn't eat this. Looks important.";
go = "You encourange the key, but it doesn't anywhere on its own.";
hit = "Nothing good comes from violence.";
open = "You can't open this.";
operate = "But where should it go?";
